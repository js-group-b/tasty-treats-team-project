import{a as l}from"./vendor-N5iQpiFS.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=n(e);fetch(e.href,t)}})();const g=document.querySelectorAll(".pop-recipe-img");g.forEach(s=>{s.addEventListener("click",y)});async function y(s){let a=`https://tasty-treats-backend.p.goit.global/api/recipes/${s.target.id}`;const i=(await l.get(a)).data;document.querySelector("#id=see-recipes-modal-name").innerText=i.title.toUpperCase();let t=i.youtube.replace("watch?v=","embed/");document.querySelector("#see-recipes-modal-video").innerHTML=`
...
//# sourceMappingURL=main-CFA54l7e.js.map
